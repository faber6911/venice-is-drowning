...
Il dataset dei livelli di marea è stato "assemblato" dai dataset storici annuali forniti dal Comune di Venezia, in particolare dal [Centro Previsioni e Segnalazioni Maree](https://www.comune.venezia.it/node/6214). I dati riguardanti invece le variabili meteorologiche è stato fornito, su richiesta, da [ARPA Veneto](https://www.arpa.veneto.it/). Tutte le operazioni di preprocessing riguardanti l'assemblaggio, l'ispezione e la conclusiva unione dei dataset citati sono disponibili in alcuni script/html realizzati in questo ordine:
...
<figcaption>fig 1: Visualizzazione della serie storica con relativi plot di autocorrelazione</figcaption>
</figure>
</center>
<br>
...
<figcaption>fig 2: Distribuzione dei valori della serie storica</figcaption>
</figure>
</center>
<br>
...
<figcaption>fig 3: output di test ADF</figcaption>
</figure>
</center>
<br>
Successivamente alla verifica della stazionarità in media si è proceduto a verificare la stationarietà in varianza

<center>
<figure>
![fig 4: variance stationary](imgs/var_stationary.jpg)
<figcaption>fig 4: verifica stazionarietà</figcaption>
</figure>
</center>
<br>