...
The datasets used for the project pipeline are two: the first dataset contains the tides level measurements, obtained through the use of a sensor, in the Venice lagoon 
